...
[![Security Rating](https://sonarcloud.io/api/project_badges/measure?project=qbicsoftware_linksmith&metric=security_rating)](https://sonarcloud.io/summary/new_code?id=qbicsoftware_linksmith)
...
[![Maintainability Rating](https://sonarcloud.io/api/project_badges/measure?project=qbicsoftware_linksmith&metric=sqale_rating)](https://sonarcloud.io/summary/new_code?id=qbicsoftware_linksmith)
...
[![Bugs](https://sonarcloud.io/api/project_badges/measure?project=qbicsoftware_linksmith&metric=bugs)](https://sonarcloud.io/summary/new_code?id=qbicsoftware_linksmith)
[![Duplicated Lines (%)](https://sonarcloud.io/api/project_badges/measure?project=qbicsoftware_linksmith&metric=duplicated_lines_density)](https://sonarcloud.io/summary/new_code?id=qbicsoftware_linksmith)
